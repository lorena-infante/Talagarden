...
const getNativos = async()=>{
    ...
    try{
        ...
        //recorriendo la data y chequeando que solo traiga los árboles de la categoría "NA"
        //solo trae los CIT
        const frutales = catalogData.filter(producto => producto.id_categoria === "NA");
