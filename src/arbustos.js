...
const getArbustos = async()=>{
    ...
    try{
        ...
        //recorriendo la data y chequeando que solo traiga los árboles de la categoría "AR"
        //solo trae los CIT
        const frutales = catalogData.filter(producto => producto.id_categoria === "AR");
